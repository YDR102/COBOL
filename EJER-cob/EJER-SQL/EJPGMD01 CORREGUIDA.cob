      ...
      *
       FD FINCIDE
           RECORDING MODE IS F.
       01  REG-FINCIDE                PIC X(55).
      *
       FD FSALIDA
           RECORDING MODE IS F.
       01  REG-FSALIDA                PIC X(042).
      *
      ...
      *
       2000-PROCESO.
      *
           IF WK-SISIN = SPACES OR LOW-VALUES
      ...
      *
           ...
           EVALUATE SQLCODE
               WHEN 0
                   DISPLAY 'DSTOS RECUPURADOS CORRECTAMENTE'
                   DISPLAY 'TIPOCOT: ' TB-TIPOCOT
                   DISPLAY 'DESCRIPCION: ' TB-DESCRIPCION
                   DISPLAY 'FECHAVIG: ' TB-FECHAVIG
                   DISPLAY 'PORCENTAJE: ' TB-PORCENTAGE
      *
                   PERFORM 2200-ESCRIBIR-FSALIDA
                      THRU 2200-ESCRIBIR-FSALIDA-EXIT
      *
               WHEN 100
                   DISPLAY 'NO SE HA ENCONTRADO EL REGISTRO'
                   DISPLAY 'TIPOCOT: ' TB-TIPOCOT
      *
      ...
      *
               WHEN OTHER
                   DISPLAY 'ERROR AL RECUPERAR LOS DATOS'
                   DISPLAY 'TIPOCOT: ' TB-TIPOCOT
