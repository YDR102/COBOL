      ...
      *
       01  VARIAVLES.
           ...
           05  IMPOT-CAUMULADO                    PIC 9(07)V9(02).
      *
       01  CN-CONTADORES.
      ...
      *
       2000-PROCESO.
      *
           IF C-CLIENTE = CLI-ANTE
                COMPUTE IMPOT-CAUMULADO = IMPOT-CAUMULADO +
                                          IMPORT-FACTURA
           ELSE
                PERFORM 2100-INFORMAR-FCLIENT
                   THRU 2100-INFORMAR-FCLIENT-EXIT
                PERFORM 2300-ESCRIBIR-FCLIENT
                   THRU 2300-ESCRIBIR-FCLIENT-EXIT
      *
                MOVE CT-0                     TO IMPOT-CAUMULADO
                MOVE IMPORT-FACTURA           TO IMPOT-CAUMULADO
                MOVE C-CLIENTE                TO CLI-ANTE
           END-IF
      *
           PERFORM 9000-LEER-FENTRADA
              THRU 9000-LEER-FENTRADA-EXIT
           PERFORM 2200-INFORMAR-FESTADO
              THRU 2200-INFORMAR-FESTADO-EXIT
      ...
      *
      ******************************************************************
      * 2100-INFORMAR-FCLIENT                                          *
      ******************************************************************
      *
       2100-INFORMAR-FCLIENT.
      *
           MOVE CLI-ANTE                     TO C-CLIENTE-S1
           MOVE IMPOT-CAUMULADO              TO IMPORT-FACTURA
      *
           .
      *
       2100-INFORMAR-FCLIENT-EXIT.
           EXIT.
      *
      ******************************************************************
      * 2200-INFORMAR-FESTADO                                          *
      ******************************************************************
      *
       2200-INFORMAR-FESTADO.
      *
           ...
           MOVE IMPORT-FACTURA               TO IMPORT-FACTURA-S2
      *
      ...
      *
           .
      *
       2200-INFORMAR-FESTADO-EXIT.
           EXIT.
      *
      ******************************************************************
      * 2300-ESCRIBIR-FCLIENT                                          *
      ******************************************************************
      *
       2300-ESCRIBIR-FCLIENT.
      *
