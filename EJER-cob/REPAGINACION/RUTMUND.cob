      ...
      * CONSTANTES ALFANUMERICAS
       01 CA-CONSTANTES-ALF.
          05 CA-PGM                    PIC X(08) VALUE 'RUTMUND'.
      ...
      *-------------- DEFINIMOS LOS CURSORES ---------
           EXEC SQL
               DECLARE CURSOR_LISTA CURSOR FOR
                  SELECT SELECCION
                        ,ENTRENADOR
                        ,NUM_JUGADORES_CONV
      ...
      *
                    DISPLAY 'OPCION -R-'
                    MOVE SELECCION-REP           TO TB-SELECCION
      ...
      *
           EVALUATE SQLCODE
              ...
              WHEN OTHER
                   ...
                   MOVE 'MUNDIAL'                     TO TABLA-ERR
                   MOVE '2100-ABRIR-CURSOR-LISTA'     TO PARRAFO-ERR
      ...
      *
           EVALUATE SQLCODE
              ...
              WHEN OTHER
                   ...
                   MOVE 'MUNDIAL'                     TO TABLA-ERR
                   MOVE '2200-LEER-CURSOR-LISTA '     TO PARRAFO-ERR
                   MOVE SQLCODE                       TO SQLCODE-ERR
                   MOVE CA-PGM                        TO NOMRUTINA-ERR
      *
                   PERFORM 3000-FIN
      ...
      *
           EVALUATE SQLCODE
              ...
              WHEN OTHER
                   ...
                   MOVE 'MUNDIAL'                     TO TABLA-ERR
                   MOVE '2300-CERRAR-CURSOR-LISTA'    TO PARRAFO-ERR
                   MOVE SQLCODE                       TO SQLCODE-ERR
                   MOVE CA-PGM                        TO NOMRUTINA-ERR
      *
                   PERFORM 3000-FIN
      ...
      *-- INFORMAR EL OCCURS DE SALIDA CON LOS DATOS DEL FETCH
            ...
            MOVE TB-SELECCION        TO SELECCION(CONT-LEIDOS)
            MOVE TB-ENTRENADOR       TO ENTRENADOR(CONT-LEIDOS)
            MOVE TB-NUM-JUGADORES-CONV
            TO NUM-JUGADORES-CONV(CONT-LEIDOS)
            MOVE TB-FECHA-PRIMER-PARTIDO
            TO FECHA-PRIMER-PARTIDO(CONT-LEIDOS)
            MOVE TB-GRUPO            TO GRUPO(CONT-LEIDOS)
            MOVE TB-FASE-ELIMINACION TO FASE-ELIMINACION(CONT-LEIDOS)
            MOVE TB-TIMESTAMP-MODIF  TO TIMESTAMP-MODIF(CONT-LEIDOS)
            MOVE TB-USUARIO-MODIF    TO USUARIO-MODIF(CONT-LEIDOS)
      *
            MOVE TB-SELECCION      TO SELECCION-REP
      *
      ...
      *
           EVALUATE SQLCODE
              ...
              WHEN OTHER
                   ...
                   MOVE 'OPEN'                        TO ACCION-ERR
                   MOVE 'MUNDIAL'                     TO TABLA-ERR
                   MOVE '2400-ABRIR-CURSOR-REPAG1'    TO PARRAFO-ERR
                   MOVE SQLCODE                       TO SQLCODE-ERR
                   MOVE CA-PGM                        TO NOMRUTINA-ERR
      *
                   PERFORM 3000-FIN
      ...
      *
           EVALUATE SQLCODE
              ...
              WHEN OTHER
                   ...
                   MOVE 'FETCH'                       TO ACCION-ERR
                   MOVE 'MUNDIAL'                     TO TABLA-ERR
                   MOVE '2500-LEER-CURSOR-REPAG1'     TO PARRAFO-ERR
                   MOVE SQLCODE                       TO SQLCODE-ERR
                   MOVE CA-PGM                        TO NOMRUTINA-ERR
      *
                   PERFORM 3000-FIN
      ...
      *
           EVALUATE SQLCODE
              ...
              WHEN OTHER
                   ...
                   MOVE 'CLOSE'                       TO ACCION-ERR
                   MOVE 'MUNDIAL'                     TO TABLA-ERR
                   MOVE '2600-CERRAR-CURSOR-REPAG1'   TO PARRAFO-ERR
                   MOVE SQLCODE                       TO SQLCODE-ERR
                   MOVE CA-PGM                        TO NOMRUTINA-ERR
      *
                   PERFORM 3000-FIN
