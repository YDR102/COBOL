      ...
      * CONSTANTES ALFANUMERICAS
       01 CA-CONSTANTES-ALF.
          05 CA-PGM                    PIC X(08) VALUE 'CBLMITAB'.
          05 CA-RUT                    PIC X(08) VALUE 'RUTMITAB'.
      ...
      *
           ...
           DISPLAY '* VECES LLAMADA  LA RUT:      *' WK-REG-LLAMADAS
           DISPLAY '* CABVECERAS   ESCRITAS:      *' WK-CABECERAS
           DISPLAY '*******************************'
      *
           .
