      ...
      * CONSTANTES ALFANUMERICAS
       01 CA-CONSTANTES-ALF.
          05 CA-PGM                    PIC X(08) VALUE 'CBLBRLR'.
          05 CA-RUT                    PIC X(08) VALUE 'RUTBRLR'.
      ...
      *
       01 WK-SALIDA.
          ...
          05 S-OFFICE            PIC X(4).
          05 S-CD                PIC X(2).
          05 S-COUNT-NUMBER      PIC X(7).
          05 S-CUSTOMER          PIC S9(10).
          05 S-TYPE              PIC X(15).
          05 S-BALANCE           PIC S9(15)V9(2).
          05 S-CURRENCY          PIC X(3).
          05 S-NAME              PIC X(20).
          05 S-SURNAME           PIC X(50).
          05 S-CITY              PIC X(20).
          05 S-COUNTRY           PIC X(20).
          05 S-BIRTHDAY          PIC X(10).
      *
       01 WK-INDICES.
          05 IND                 PIC 9(03).
      ...
      *
           ...
           DISPLAY '* RETORNO     DEL ERROR:   *' RETORNO
           DISPLAY '* SUBRETORNO  DEL ERROR:   *' SUBRETORNO
           DISPLAY '* ACCION      DEL ERROR:   *' ACCION
           DISPLAY '* SQLCODE PGM DEL ERROR:   *' SQLCODE-E
           DISPLAY '* TABLA       DEL ERROR:   *' TABLA
           DISPLAY '* PARRAFO     DEL ERROR:   *' PARRAFO
           DISPLAY '* NOMBRE RUT  DEL ERROR:   *' NOMRUTINA
           DISPLAY '****************************'
      *
           .
