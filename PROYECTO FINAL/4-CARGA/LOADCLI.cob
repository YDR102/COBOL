      ******************************************************************
      ** L O A D C L I.  -PGM CON RESPOSICIONAMIENTO QUE LEE LOS      **
      ...
      *
       FD FENTRADA
           RECORDING MODE IS F.
       01  REG-FENTRADA               PIC X(0744).
      * CLIENTES
      *
       FD FSALIDA
           RECORDING MODE IS F.
       01  REG-FSALIDA               PIC X(0744).
      * DESCARTES
      *
      ...
      *
       01  VARIABLES.
           ...
           05 TABLA                   PIC X(20) VALUE 'CLIENTES_MAPFRE'.
                    ...
                    EVALUATE TB-ESTADO
                        WHEN 'KO'
                             PERFORM 9000-LEER-FENTRADA
                               ...
                               UNTIL DNI-CLI-M > TB-VALOR-CLAVE-TEXT
                        WHEN 'OK'
                             PERFORM 9000-LEER-FENTRADA
                                THRU 9000-LEER-FENTRADA-EXIT
                        WHEN OTHER
      ...
      *
       2000-PROCESO.
      *
           PERFORM 2100-INSERT-CLIENTES
              THRU 2100-INSERT-CLIENTES-EXIT
      *
      ...
      *
      ******************************************************************
      ** 2100-INSERT-CLIENTES                                         **
      ** INSERTAMOS EL REGISTRO LEIDO DEL FICHERO EN LA TABLA CLIENTES**
      ** CONTROLANDO POSTERIORMENTE SU SQLCODE.                       **
      ******************************************************************
      *
       2100-INSERT-CLIENTES.
      *
           MOVE DNI-CLI-M                  TO TB-DNI
           MOVE NOMBRE-CLI-M               TO TB-NOMBRE
           MOVE DIRECCION-CLI-M            TO TB-DIRECCION
           MOVE TELEFONO-CLI-M             TO TB-TELEFONO
      ...
      *
           EVALUATE SQLCODE
               ...
               WHEN -803
                    DISPLAY 'ERROR: REG. DUPLICADO EN BBDD'
                    DISPLAY 'PARRAFO: 2100-INSERT-CLIENTES'
                    DISPLAY 'TABLA: ' TABLA
                    MOVE SQLCODE TO WK-SQLCODE
                    DISPLAY 'SQLCODE: ' WK-SQLCODE
      *
      ...
      *
           .
      *
       2100-INSERT-CLIENTES-EXIT.
           EXIT.
      *
      ******************************************************************
      ** 2200-UPDATE-DAREPOS                                          **
      ** ACTUALIZAMOS EL VALOR DE LA CLAVE EN LA DAREPOS CON LA        *
      ** MATRICULA QUE ACABAMOS DE INSSERTAR EN LA TABLA CLIENTES.    **
      ******************************************************************
      *
       2200-UPDATE-DAREPOS.
      *
           MOVE 'KO'                        TO TB-ESTADO
           MOVE DNI-CLI-M                   TO TB-VALOR-CLAVE-TEXT
      ...
      *
       2300-ESCRIBIR-FSALIDA.
      *
           WRITE REG-FSALIDA        FROM DATOS-CLI-M
      *
           IF FS-FSALIDA NOT = CT-00
      ...
      *
       9000-LEER-FENTRADA.
      *
           READ FENTRADA INTO DATOS-CLI-M
      *
