      ******************************************************************
      ** L O A D V I D.  -PGM CON RESPOSICIONAMIENTO QUE LEE LOS      **
      **                  REGISTROS DEL FICHERO DE ENTRADA CON INFO   **
      **                  DE VIDA Y LOS INSERTA POSTERIORMENTE        **
      **                  EN BBDD.                                    **
      ******************************************************************
      *
      ******************************************************************
      ...
      *
       FD FENTRADA
           RECORDING MODE IS F.
       01  REG-FENTRADA               PIC X(0549).
      * VIDA
      *
       FD FSALIDA
           RECORDING MODE IS F.
       01  REG-FSALIDA               PIC X(0549).
      * DESCARTES
      *
      ...
      *
       01  VARIABLES.
           ...
           05 TABLA                   PIC X(20) VALUE 'VIDA_MAPFRE'.
                    ...
                    EVALUATE TB-ESTADO
                        WHEN 'KO'
                             PERFORM 9000-LEER-FENTRADA
                               ...
                               UNTIL POLIZA-VID > TB-VALOR-CLAVE-TEXT
                        WHEN 'OK'
                             PERFORM 9000-LEER-FENTRADA
                                THRU 9000-LEER-FENTRADA-EXIT
                        WHEN OTHER
      ...
      ******************************************************************
      ** 2000-PROCESO                                                 **
      ** INSERTAMOS EL ULTIMO REGISTRO EN LA TABLA VIDA. A            **
      ** CONTINUACION ACTUALIZAMOS LA DAREPOS CON EL VALOR CLAVE DEL  **
      ** REGISTRO QUE ACABAMOS DE INSERTAR EN LA TABLA VIDA.          **
      ******************************************************************
      *
       2000-PROCESO.
      *
           PERFORM 2100-INSERT-VIDA
              THRU 2100-INSERT-VIDA-EXIT
      *
      ...
      ******************************************************************
      ** 2100-INSERT-VIDA                                             **
      ** INSERTAMOS EL REGISTRO LEIDO DEL FICHERO EN LA TABLA VIDA    **
      ...
      *
           EVALUATE SQLCODE
               ...
               WHEN -803
                    DISPLAY 'ERROR: REG. DUPLICADO EN BBDD'
                    DISPLAY 'PARRAFO: 2100-INSERT-VIDA'
                    DISPLAY 'TABLA: ' TABLA
                    MOVE SQLCODE TO WK-SQLCODE
                    DISPLAY 'SQLCODE: ' WK-SQLCODE
      *
      ...
      *
           .
      *
       2100-INSERT-VIDA-EXIT.
           EXIT.
      *
      ******************************************************************
      ** 2200-UPDATE-DAREPOS                                          **
      ** ACTUALIZAMOS EL VALOR DE LA CLAVE EN LA DAREPOS CON LA        *
      ** MATRICULA QUE ACABAMOS DE INSSERTAR EN LA TABLA VIDA.        **
      ******************************************************************
      *
       2200-UPDATE-DAREPOS.
      *
           MOVE 'KO'                        TO TB-ESTADO
           MOVE POLIZA-VID                  TO TB-VALOR-CLAVE-TEXT
      ...
      *
       2300-ESCRIBIR-FSALIDA.
      *
           WRITE REG-FSALIDA        FROM DATOS-VID
      *
           IF FS-FSALIDA NOT = CT-00
