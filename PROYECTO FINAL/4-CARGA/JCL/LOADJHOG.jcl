...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD   *
 DELETE DES.TRANS.HOGAR.MAP.F300519.OR
 DELETE DES.TRANS.HOGAR.MAP.F300519.ERR
 SET MAXCC=0
/*
//*---------------------------------------------------------------------
...
//SYSOUT   DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//SORTIN   DD DSN=DES.TRANS.HOGAR.MAP.F300519,DISP=SHR
//SORTOUT  DD DSN=DES.TRANS.HOGAR.MAP.F300519.OR,
...
//FSALIDA  DD DSN=DES.TRANS.HOGAR.MAP.F300519.ERR,
//            DISP=(,CATLG,DELETE),
//            SPACE=(TRK,(5,5),RLSE)
//SYSOUT   DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
...
//SYSTSIN  DD *
 DSN SYSTEM(DB8G)
 RUN PLAN(LOADHOG) PROGRAM(LOADHOG)
 END
/*