      ...
      * CONSTANTES ALFANUMERICAS
       01 CA-CONSTANTES-ALF.
          ...
          05 CA-TABLA                  PIC X(10) VALUE 'EXTRCLI'.
      ...
      *     PROCEDURE DIVISION                                         *
      ******************************************************************
       PROCEDURE DIVISION USING CPYRUTCL.
      *
           PERFORM 1000-INICIO
      ...
      *
                    PERFORM 2300-CERR-CURSOR-LISTREG
                       THRU 2300-CERR-CURSOR-LISTREG-EXIT
               WHEN CA-R
      *
                    DISPLAY 'OPCION -R-'
                    MOVE DNI-REP           TO TB-DNI-CL
                    PERFORM 2100-ABRIR-CURSOR-LISTREG
                       THRU 2100-ABRIR-CURSOR-LISTREG-EXIT
      *
                    PERFORM 2200-LEER-CURSOR-LISTREG
      ...
      *
           EVALUATE SQLCODE
              ...
              WHEN OTHER
                   ...
                   MOVE CA-TABLA                      TO TABLA-ERR
                   MOVE '2300-CERR-CURSOR-LISTREG'  TO PARRAFO-ERR
                   MOVE SQLCODE                       TO SQLCODE-ERR
                   MOVE CA-PGM                        TO NOMRUTINA-ERR
      *
                   PERFORM 3000-FIN
      ...
      *-- INFORMAR EL OCCURS DE SALIDA CON LOS DATOS DEL FETCH
            ...
            MOVE TB-OBSERVACIONES-TEXT TO OBSERVACIONES(CONT-LEIDOS)
      *
            MOVE TB-DNI-CL           TO DNI-REP
